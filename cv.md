...
accompagnée par un conseiller syndical


#### 2016 - 2021 - dtc innovation

- Recherche/veille légale pour comprendre si/comment il est possible légalement d'être à la fois dirigeant d'une association et salarié de celle-ci. Comparaison avec d'autres modèles (Scop, SARL "classique")
- Rédaction de statuts associatif de zéro pour avoir une structure de pouvoir "plate"
- Déclarations auprès de la Préfécture et du service des impôts (fiscalisation de l'association)
- Rédaction de contrats de travail
- Recherche de la compatibilité entre le statut de dirigeant d'association et droit aux allocations chômage
- Travail équivalent pour le statut Scop
- Relation directe avec les comptables (volets fiscal et social) avec débats contradictoires sur leurs conseils
- Rédactions des actes et procès verbaux d'AG au besoin
- Changement de cabinet comptable
- Rédaction contrats de prestation
- Réponses à marché publics (volets techniques et administratifs)
- Demande d'ouverture de documents administratifs (CADA)
- Création d'un outil numérique open source permettant aux administrations de respecter leurs obligations relatives à l'Article L311-7 du CRPA
- Gestion d'un contrôle fiscal
- Gestion d'une procédure d'activité partielle
- Gestion d'un licenciement économique et d'une rupture conventionelle
- Dissolution association, rôle liquidateur (PV AG, déclarations Préfecture, URSSAF, impôts, distribution boni liquidation)


#### 2020 - 2023 - L'Échappée Belle

- Évaluation et comparaison de différentes option (association, scop, CAE)
- Rédaction de zéro des statuts pour correspondre à nos besoins/envies
- Déclarations auprès de la Préfécture et du service des impôts (fiscalisation de l'association)
- Formation jusqu'à l'autonomie des autres membres de l'association au Droit et à la rédaction de nos statuts
- Rédaction de contrats de travail
- Rédactions des actes et procès verbaux d'AG au besoin
- Mise en place d'un outil de suivi de comptabilité individualisé type CAE
- Accompagnement RGPD d'un hébergeur de services numériques
- Relation avec le cabinet comptable sur les volets social et fiscaux


#### 2022 - Gérant SCI YED

- Rédaction de zéro des statuts pour correspondre à nos besoins/envies
- Étude des différentes formes possibles (Indivision, Société Civile, Société en Nom Collectif)
- Étude de différents montages financiers possibles et notamment leurs conséquences fiscales et sociales
- Rédactions des actes et procès verbaux d'AG au besoin
- Gestion des procédures auprès des greffes pour la création, puis la modification
- Formation des autres associé.e.s au Droit et à la rédaction de nos statuts
- Formation des autres associé.e.s à la partie fiscale de la SCI (déclaration SCI et impôt sur le revenu)
